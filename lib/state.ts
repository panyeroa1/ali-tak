...
2. **MIMIC the speaker's voice elements**:
   ...
   - If the speaker is speaking softly, respond softly. If they are excited, be excited.
...
export const useSettings = create<{
  ...
  aliasVersion: DEFAULT_ALIAS_VERSION,
  ...
  setAlias: (aliasName, aliasVersion) =>
    set({ aliasName, aliasVersion, aliasId: `${aliasName}-${aliasVersion}` }),
